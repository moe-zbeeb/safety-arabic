...
SCRIPT="${SCRIPT:-$REPO_ROOT/Guarded-response-eval/Eval/eval_guarded.py}"
...
echo "[run_guard_sweep] Next: build the 4-setup table with python Guarded-response-eval/build_four_setup_comparison.py --exp-dir <dir>"
